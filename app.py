...
consumerKey = "nknw4002hgAx8w0BGXFSVauPk"
consumerSecret = "IfflANsSpwsgHsJJF63avjT3HGa5nxF4sTGHVVFx48xdfHy3dC"
accessToken = "2646919157-N4FZdklqeuLgsjJ30FLPX8xhvBWnUcoaNO339TW"
accessTokenSecret = "Mx9bZ4OJiTHRON89NgDhMiGNozmTEcNrILwHydOlTZ3yS"
...
def app():
	...
	st.title("Sentiment Analysis of Twitter data")


	activities=["Tweet Analysis","Generate Twitter Data"]
	...
	if choice=="Tweet Analysis":
		...
		st.write("1. Fetch the first 5 tweets of the user")
		...
		user_name = st.text_area("*Enter the exact twitter handle of the Personality")
		st.text("NB: DO NOT use @ because it was scrapped during implementation of this application")
	...
	st.subheader("Lozpdata project")
	st.subheader("By: Andrew Okello")
